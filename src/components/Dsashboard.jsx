...
import { obj } from '../utils/objexample';
const Dashbaord = () => {
										...
										<tr key={rw.id}>
											...
											<td>
												<a
													...
													className='edit '
													data-toggle='modal'
													onClick={(e) => setEditFeilds(rw)}>
													<MdModeEditOutline fontSize='2rem' />
												</a>
												<a
													href='#deleteEmployeeModal'
													onClick={(e) => settoDelete(rw.id)}
													className='delete'
													data-toggle='modal'>
													<MdOutlineDeleteOutline fontSize='2rem' />
												</a>
											</td>
										</tr>
									);
				...
				<div className='modal-dialog'>
					<div className='modal-content'>
						<form onSubmit={(e) => handleDelete(e)}>
							...
							<div className='modal-body'>
								<p>
									Are you sure you want to delete these Record with id{' '}
									{toDelete}?
								</p>
